...
; Flat look: white content background with neutral dark text
!define MUI_BGCOLOR "FFFFFF"
!define MUI_TEXTCOLOR "222222"
...
!if "${LICENSE}" != ""
  !define MUI_PAGE_CUSTOMFUNCTION_PRE SkipIfPassive
  ; Require explicit consent: "I Agree" stays disabled until the box is checked
